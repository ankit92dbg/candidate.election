                   ...
                   <div class="col-4">
                        <div class="mb-3">
                            ...
                            <select id="category" name="category" class="form-select" required>
                                <option value="" selected>Please Select</option>
                                <option value="0" <?php echo ($_GET['category']=='0') ? "selected" : ""; ?>>Zila</option>
                                <option value="1" <?php echo ($_GET['category']=='1') ? "selected" : ""; ?>>Zone</option>
                                <option value="2" <?php echo ($_GET['category']=='2') ? "selected" : ""; ?>>Center</option>
                                <option value="3" <?php echo ($_GET['category']=='3') ? "selected" : ""; ?>>Booth</option>
                            </select>   
                        </div>
                    </div>
                    <div class="col-4">
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    if(!data.error)
                    {
                       ...
                       setTimeout(() => {
                            window.location.href="subleaders.php"
                        }, 2000);
                    }
                    if(data.error)
                    {
