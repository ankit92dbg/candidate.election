            ...
            <div class="card-header pb-0 p-3">
              <div class="row">
                <div class="col-lg-6 d-flex justify-content-between">
                    <h6 class="mb-2">Scheme List</h6>
                </div>
                <div class="col-lg-6">
                    <a style="float:right;" class="btn btn-primary" href="add-scheme.php">Add Scheme</a>
                </div> 
                <div class="col-lg-12">
                        <div class="row">
                          <div class="col-lg-4 d-flex justify-content-between">
                              <input type="text" onchange="load_data()" onkeyup="load_data()" onkeydown="load_data()" id="search_str" class="form-control" placeholder="Search by Scheme Name" />
                            </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p><strong>Are you sure, you want to delete this scheme?</strong></p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal">No</button>
                    <button type="button" onclick="delScheme()" class="btn btn-danger">Yes</button>
                  </div>
                </div>
              </div>
            </div>
 ...
 function changeStatus(val)  
      ...
      function delScheme(){
        ...
        $.ajax({  
                url:"../ajax/master-data.php",  
                method:"POST",  
                data:{id:$('#delete_id').val(),action:"delete_scheme"},  
                success:function(data){  
                    load_data()
                }  
           }) 
