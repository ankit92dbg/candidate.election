...
if($search_str==''){
  $query = "SELECT * FROM social_media WHERE leader_id='$leader_id' ORDER BY id DESC LIMIT $start_from, $record_per_page";  
}else{
  $query = "SELECT * FROM social_media WHERE leader_id='$leader_id' AND title LIKE '%".$search_str."%' ORDER BY id DESC LIMIT $start_from, $record_per_page";  
}
...
{  
    ...
    <tr>
      ...
      <td class="align-middle">
      <a target="_blank" href="'.$row['url'].'">View</a>
      </td>';    
      ...
      <td class="align-middle">
          <div class="dp">
              ...
              <ul class="dropdown-menu drop-menu dropdown-menu-dark bg-dark" role="menu">
