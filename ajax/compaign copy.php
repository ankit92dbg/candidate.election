...
if($search_str==''){
  $query = "SELECT * FROM compaign WHERE leader_id='$leader_id' ORDER BY id DESC LIMIT $start_from, $record_per_page";  
}else{
  $query = "SELECT * FROM compaign WHERE leader_id='$leader_id' AND title LIKE '%".$search_str."%' ORDER BY id DESC LIMIT $start_from, $record_per_page";  
}
